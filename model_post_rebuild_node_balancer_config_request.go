...
// checks if the PostRebuildNodeBalancerConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRebuildNodeBalancerConfigRequest{}

// PostRebuildNodeBalancerConfigRequest struct for PostRebuildNodeBalancerConfigRequest
type PostRebuildNodeBalancerConfigRequest struct {
	...
	Nodes []PostRebuildNodeBalancerConfigRequestAllOfNodesInner `json:"nodes"`
}

type _PostRebuildNodeBalancerConfigRequest PostRebuildNodeBalancerConfigRequest
...
func NewPostRebuildNodeBalancerConfigRequest(nodes []PostRebuildNodeBalancerConfigRequestAllOfNodesInner) *PostRebuildNodeBalancerConfigRequest {
	this := PostRebuildNodeBalancerConfigRequest{}
...
func (o *PostRebuildNodeBalancerConfigRequest) SetSslCertNil() {
	o.SslCert.Set(nil)
}
...
func (o *PostRebuildNodeBalancerConfigRequest) SetSslKeyNil() {
	o.SslKey.Set(nil)
}
...
func (o *PostRebuildNodeBalancerConfigRequest) GetNodes() []PostRebuildNodeBalancerConfigRequestAllOfNodesInner {
	if o == nil {
		var ret []PostRebuildNodeBalancerConfigRequestAllOfNodesInner
		return ret
	}
...
func (o PostRebuildNodeBalancerConfigRequest) MarshalJSON() ([]byte, error) {
...
func (o PostRebuildNodeBalancerConfigRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostRebuildNodeBalancerConfigRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRebuildNodeBalancerConfigRequest := _PostRebuildNodeBalancerConfigRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRebuildNodeBalancerConfigRequest)

	if err != nil {
		return err
	}

	*o = PostRebuildNodeBalancerConfigRequest(varPostRebuildNodeBalancerConfigRequest)

	return err
}

type NullablePostRebuildNodeBalancerConfigRequest struct {
	value *PostRebuildNodeBalancerConfigRequest
	isSet bool
}

func (v NullablePostRebuildNodeBalancerConfigRequest) Get() *PostRebuildNodeBalancerConfigRequest {
	return v.value
}

func (v *NullablePostRebuildNodeBalancerConfigRequest) Set(val *PostRebuildNodeBalancerConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRebuildNodeBalancerConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRebuildNodeBalancerConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRebuildNodeBalancerConfigRequest(val *PostRebuildNodeBalancerConfigRequest) *NullablePostRebuildNodeBalancerConfigRequest {
	return &NullablePostRebuildNodeBalancerConfigRequest{value: val, isSet: true}
}

func (v NullablePostRebuildNodeBalancerConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRebuildNodeBalancerConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
