...
// checks if the GetLinodeConfigs200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinodeConfigs200Response{}

// GetLinodeConfigs200Response struct for GetLinodeConfigs200Response
type GetLinodeConfigs200Response struct {
	Data []GetLinodeConfigs200ResponseDataInner `json:"data,omitempty"`
...
func NewGetLinodeConfigs200Response() *GetLinodeConfigs200Response {
	this := GetLinodeConfigs200Response{}
	return &this
}
...
func (o *GetLinodeConfigs200Response) GetData() []GetLinodeConfigs200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLinodeConfigs200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLinodeConfigs200ResponseDataInner and assigns it to the Data field.
...
func (o GetLinodeConfigs200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLinodeConfigs200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinodeConfigs200Response struct {
	value *GetLinodeConfigs200Response
	isSet bool
}

func (v NullableGetLinodeConfigs200Response) Get() *GetLinodeConfigs200Response {
	return v.value
}

func (v *NullableGetLinodeConfigs200Response) Set(val *GetLinodeConfigs200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinodeConfigs200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinodeConfigs200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinodeConfigs200Response(val *GetLinodeConfigs200Response) *NullableGetLinodeConfigs200Response {
	return &NullableGetLinodeConfigs200Response{value: val, isSet: true}
}

func (v NullableGetLinodeConfigs200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinodeConfigs200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
