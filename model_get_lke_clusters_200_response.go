...
// checks if the GetLkeClusters200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLkeClusters200Response{}

// GetLkeClusters200Response struct for GetLkeClusters200Response
type GetLkeClusters200Response struct {
	Data []GetLkeClusters200ResponseDataInner `json:"data,omitempty"`
...
func NewGetLkeClusters200Response() *GetLkeClusters200Response {
	this := GetLkeClusters200Response{}
	return &this
}
...
func (o *GetLkeClusters200Response) GetData() []GetLkeClusters200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLkeClusters200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLkeClusters200ResponseDataInner and assigns it to the Data field.
...
func (o GetLkeClusters200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLkeClusters200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLkeClusters200Response struct {
	value *GetLkeClusters200Response
	isSet bool
}

func (v NullableGetLkeClusters200Response) Get() *GetLkeClusters200Response {
	return v.value
}

func (v *NullableGetLkeClusters200Response) Set(val *GetLkeClusters200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLkeClusters200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLkeClusters200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLkeClusters200Response(val *GetLkeClusters200Response) *NullableGetLkeClusters200Response {
	return &NullableGetLkeClusters200Response{value: val, isSet: true}
}

func (v NullableGetLkeClusters200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLkeClusters200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
