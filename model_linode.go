...
// checks if the Linode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Linode{}
...
type Linode struct {
	...
	PlacementGroup NullableLinodePlacementGroup `json:"placement_group,omitempty"`
...
func (o *Linode) SetDiskEncryptionNil() {
...
func (o *Linode) SetLkeClusterIdNil() {
...
// SetPlacementGroup gets a reference to the given NullableLinodePlacementGroup and assigns it to the PlacementGroup field.
...
func (o *Linode) SetPlacementGroupNil() {
...
func (o Linode) ToMap() (map[string]interface{}, error) {
