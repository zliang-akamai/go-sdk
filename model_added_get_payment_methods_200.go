...
// checks if the AddedGetPaymentMethods200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedGetPaymentMethods200{}

// AddedGetPaymentMethods200 struct for AddedGetPaymentMethods200
type AddedGetPaymentMethods200 struct {
...
func NewAddedGetPaymentMethods200() *AddedGetPaymentMethods200 {
	this := AddedGetPaymentMethods200{}
	return &this
}
...
func (o AddedGetPaymentMethods200) MarshalJSON() ([]byte, error) {
...
func (o AddedGetPaymentMethods200) ToMap() (map[string]interface{}, error) {
...
type NullableAddedGetPaymentMethods200 struct {
	value *AddedGetPaymentMethods200
	isSet bool
}

func (v NullableAddedGetPaymentMethods200) Get() *AddedGetPaymentMethods200 {
	return v.value
}

func (v *NullableAddedGetPaymentMethods200) Set(val *AddedGetPaymentMethods200) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedGetPaymentMethods200) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedGetPaymentMethods200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedGetPaymentMethods200(val *AddedGetPaymentMethods200) *NullableAddedGetPaymentMethods200 {
	return &NullableAddedGetPaymentMethods200{value: val, isSet: true}
}

func (v NullableAddedGetPaymentMethods200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedGetPaymentMethods200) UnmarshalJSON(src []byte) error {
	v.isSet = true
