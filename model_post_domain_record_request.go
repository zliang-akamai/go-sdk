...
// checks if the PostDomainRecordRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostDomainRecordRequest{}

// PostDomainRecordRequest struct for PostDomainRecordRequest
type PostDomainRecordRequest struct {
...
type _PostDomainRecordRequest PostDomainRecordRequest
...
func (o *PostDomainRecordRequest) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *PostDomainRecordRequest) SetServiceNil() {
	o.Service.Set(nil)
}
...
func (o *PostDomainRecordRequest) SetTagNil() {
	o.Tag.Set(nil)
}
...
func (o PostDomainRecordRequest) MarshalJSON() ([]byte, error) {
...
func (o PostDomainRecordRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostDomainRecordRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostDomainRecordRequest := _PostDomainRecordRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostDomainRecordRequest)

	if err != nil {
		return err
	}

	*o = PostDomainRecordRequest(varPostDomainRecordRequest)

	return err
}

type NullablePostDomainRecordRequest struct {
	value *PostDomainRecordRequest
	isSet bool
}

func (v NullablePostDomainRecordRequest) Get() *PostDomainRecordRequest {
	return v.value
}

func (v *NullablePostDomainRecordRequest) Set(val *PostDomainRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostDomainRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostDomainRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostDomainRecordRequest(val *PostDomainRecordRequest) *NullablePostDomainRecordRequest {
	return &NullablePostDomainRecordRequest{value: val, isSet: true}
}

func (v NullablePostDomainRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostDomainRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
