...
// checks if the GetInvoiceItems200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInvoiceItems200ResponseDataInner{}

// GetInvoiceItems200ResponseDataInner An InvoiceItem object.
type GetInvoiceItems200ResponseDataInner struct {
...
func NewGetInvoiceItems200ResponseDataInner() *GetInvoiceItems200ResponseDataInner {
	this := GetInvoiceItems200ResponseDataInner{}
	return &this
}
...
func (o *GetInvoiceItems200ResponseDataInner) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o GetInvoiceItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetInvoiceItems200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetInvoiceItems200ResponseDataInner struct {
	value *GetInvoiceItems200ResponseDataInner
	isSet bool
}

func (v NullableGetInvoiceItems200ResponseDataInner) Get() *GetInvoiceItems200ResponseDataInner {
	return v.value
}

func (v *NullableGetInvoiceItems200ResponseDataInner) Set(val *GetInvoiceItems200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInvoiceItems200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInvoiceItems200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInvoiceItems200ResponseDataInner(val *GetInvoiceItems200ResponseDataInner) *NullableGetInvoiceItems200ResponseDataInner {
	return &NullableGetInvoiceItems200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetInvoiceItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInvoiceItems200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
