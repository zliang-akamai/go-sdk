...
// checks if the GooglePay type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GooglePay{}
...
func (o GooglePay) MarshalJSON() ([]byte, error) {
...
func (o GooglePay) ToMap() (map[string]interface{}, error) {
...
type NullableGooglePay struct {
	value *GooglePay
	isSet bool
}

func (v NullableGooglePay) Get() *GooglePay {
	return v.value
}

func (v *NullableGooglePay) Set(val *GooglePay) {
	v.value = val
	v.isSet = true
}

func (v NullableGooglePay) IsSet() bool {
	return v.isSet
}

func (v *NullableGooglePay) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGooglePay(val *GooglePay) *NullableGooglePay {
	return &NullableGooglePay{value: val, isSet: true}
}

func (v NullableGooglePay) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGooglePay) UnmarshalJSON(src []byte) error {
	v.isSet = true
