...
// checks if the GetVolumeTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVolumeTypes200Response{}

// GetVolumeTypes200Response struct for GetVolumeTypes200Response
type GetVolumeTypes200Response struct {
	// The volume types.
	Data []GetVolumeTypes200ResponseDataInner `json:"data,omitempty"`
...
func NewGetVolumeTypes200Response() *GetVolumeTypes200Response {
	this := GetVolumeTypes200Response{}
	return &this
}
...
func (o *GetVolumeTypes200Response) GetData() []GetVolumeTypes200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetVolumeTypes200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetVolumeTypes200ResponseDataInner and assigns it to the Data field.
...
func (o GetVolumeTypes200Response) MarshalJSON() ([]byte, error) {
...
func (o GetVolumeTypes200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetVolumeTypes200Response struct {
	value *GetVolumeTypes200Response
	isSet bool
}

func (v NullableGetVolumeTypes200Response) Get() *GetVolumeTypes200Response {
	return v.value
}

func (v *NullableGetVolumeTypes200Response) Set(val *GetVolumeTypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVolumeTypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVolumeTypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVolumeTypes200Response(val *GetVolumeTypes200Response) *NullableGetVolumeTypes200Response {
	return &NullableGetVolumeTypes200Response{value: val, isSet: true}
}

func (v NullableGetVolumeTypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVolumeTypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
