...
// checks if the AddedGetEvents200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedGetEvents200{}

// AddedGetEvents200 struct for AddedGetEvents200
type AddedGetEvents200 struct {
...
func (o AddedGetEvents200) MarshalJSON() ([]byte, error) {
...
func (o AddedGetEvents200) ToMap() (map[string]interface{}, error) {
...
type NullableAddedGetEvents200 struct {
	value *AddedGetEvents200
	isSet bool
}

func (v NullableAddedGetEvents200) Get() *AddedGetEvents200 {
	return v.value
}

func (v *NullableAddedGetEvents200) Set(val *AddedGetEvents200) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedGetEvents200) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedGetEvents200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedGetEvents200(val *AddedGetEvents200) *NullableAddedGetEvents200 {
	return &NullableAddedGetEvents200{value: val, isSet: true}
}

func (v NullableAddedGetEvents200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedGetEvents200) UnmarshalJSON(src []byte) error {
	v.isSet = true
