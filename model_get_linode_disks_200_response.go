...
// checks if the GetLinodeDisks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinodeDisks200Response{}

// GetLinodeDisks200Response struct for GetLinodeDisks200Response
type GetLinodeDisks200Response struct {
	Data []GetLinodeDisks200ResponseDataInner `json:"data,omitempty"`
...
func NewGetLinodeDisks200Response() *GetLinodeDisks200Response {
	this := GetLinodeDisks200Response{}
	return &this
}
...
func (o *GetLinodeDisks200Response) GetData() []GetLinodeDisks200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLinodeDisks200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLinodeDisks200ResponseDataInner and assigns it to the Data field.
...
func (o GetLinodeDisks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLinodeDisks200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinodeDisks200Response struct {
	value *GetLinodeDisks200Response
	isSet bool
}

func (v NullableGetLinodeDisks200Response) Get() *GetLinodeDisks200Response {
	return v.value
}

func (v *NullableGetLinodeDisks200Response) Set(val *GetLinodeDisks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinodeDisks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinodeDisks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinodeDisks200Response(val *GetLinodeDisks200Response) *NullableGetLinodeDisks200Response {
	return &NullableGetLinodeDisks200Response{value: val, isSet: true}
}

func (v NullableGetLinodeDisks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinodeDisks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
