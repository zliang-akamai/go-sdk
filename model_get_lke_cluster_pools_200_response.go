...
// checks if the GetLkeClusterPools200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLkeClusterPools200Response{}

// GetLkeClusterPools200Response struct for GetLkeClusterPools200Response
type GetLkeClusterPools200Response struct {
	Data []GetLkeClusterPools200ResponseDataInner `json:"data,omitempty"`
...
func NewGetLkeClusterPools200Response() *GetLkeClusterPools200Response {
	this := GetLkeClusterPools200Response{}
	return &this
}
...
func (o *GetLkeClusterPools200Response) GetData() []GetLkeClusterPools200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLkeClusterPools200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLkeClusterPools200ResponseDataInner and assigns it to the Data field.
...
func (o GetLkeClusterPools200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLkeClusterPools200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLkeClusterPools200Response struct {
	value *GetLkeClusterPools200Response
	isSet bool
}

func (v NullableGetLkeClusterPools200Response) Get() *GetLkeClusterPools200Response {
	return v.value
}

func (v *NullableGetLkeClusterPools200Response) Set(val *GetLkeClusterPools200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLkeClusterPools200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLkeClusterPools200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLkeClusterPools200Response(val *GetLkeClusterPools200Response) *NullableGetLkeClusterPools200Response {
	return &NullableGetLkeClusterPools200Response{value: val, isSet: true}
}

func (v NullableGetLkeClusterPools200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLkeClusterPools200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
