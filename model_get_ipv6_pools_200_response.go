...
// checks if the GetIpv6Pools200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIpv6Pools200Response{}

// GetIpv6Pools200Response struct for GetIpv6Pools200Response
type GetIpv6Pools200Response struct {
	Data []GetIpv6Pools200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetIpv6Pools200Response) GetData() []GetIpv6Pools200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetIpv6Pools200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetIpv6Pools200ResponseDataInner and assigns it to the Data field.
...
func (o GetIpv6Pools200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIpv6Pools200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetIpv6Pools200Response struct {
	value *GetIpv6Pools200Response
	isSet bool
}

func (v NullableGetIpv6Pools200Response) Get() *GetIpv6Pools200Response {
	return v.value
}

func (v *NullableGetIpv6Pools200Response) Set(val *GetIpv6Pools200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIpv6Pools200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIpv6Pools200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIpv6Pools200Response(val *GetIpv6Pools200Response) *NullableGetIpv6Pools200Response {
	return &NullableGetIpv6Pools200Response{value: val, isSet: true}
}

func (v NullableGetIpv6Pools200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIpv6Pools200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
