...
// checks if the PostLinodeConfigInterfaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostLinodeConfigInterfaceRequest{}

// PostLinodeConfigInterfaceRequest struct for PostLinodeConfigInterfaceRequest
type PostLinodeConfigInterfaceRequest struct {
...
type _PostLinodeConfigInterfaceRequest PostLinodeConfigInterfaceRequest
...
func NewPostLinodeConfigInterfaceRequest(purpose string) *PostLinodeConfigInterfaceRequest {
	this := PostLinodeConfigInterfaceRequest{}
...
func (o *PostLinodeConfigInterfaceRequest) SetIpamAddressNil() {
...
func (o *PostLinodeConfigInterfaceRequest) SetLabelNil() {
	o.Label.Set(nil)
}
...
func (o *PostLinodeConfigInterfaceRequest) SetSubnetIdNil() {
	o.SubnetId.Set(nil)
}
...
func (o *PostLinodeConfigInterfaceRequest) SetVpcIdNil() {
	o.VpcId.Set(nil)
}
...
func (o PostLinodeConfigInterfaceRequest) MarshalJSON() ([]byte, error) {
...
func (o PostLinodeConfigInterfaceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostLinodeConfigInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostLinodeConfigInterfaceRequest := _PostLinodeConfigInterfaceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostLinodeConfigInterfaceRequest)

	if err != nil {
		return err
	}

	*o = PostLinodeConfigInterfaceRequest(varPostLinodeConfigInterfaceRequest)

	return err
}

type NullablePostLinodeConfigInterfaceRequest struct {
	value *PostLinodeConfigInterfaceRequest
	isSet bool
}

func (v NullablePostLinodeConfigInterfaceRequest) Get() *PostLinodeConfigInterfaceRequest {
	return v.value
}

func (v *NullablePostLinodeConfigInterfaceRequest) Set(val *PostLinodeConfigInterfaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostLinodeConfigInterfaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostLinodeConfigInterfaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostLinodeConfigInterfaceRequest(val *PostLinodeConfigInterfaceRequest) *NullablePostLinodeConfigInterfaceRequest {
	return &NullablePostLinodeConfigInterfaceRequest{value: val, isSet: true}
}

func (v NullablePostLinodeConfigInterfaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostLinodeConfigInterfaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
