...
// checks if the GetBetaPrograms200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBetaPrograms200Response{}

// GetBetaPrograms200Response struct for GetBetaPrograms200Response
type GetBetaPrograms200Response struct {
	...
	Data []GetBetaPrograms200ResponseAllOfDataInner `json:"data,omitempty"`
}
...
func NewGetBetaPrograms200Response() *GetBetaPrograms200Response {
	this := GetBetaPrograms200Response{}
	return &this
}
...
func (o *GetBetaPrograms200Response) GetData() []GetBetaPrograms200ResponseAllOfDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetBetaPrograms200ResponseAllOfDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetBetaPrograms200ResponseAllOfDataInner and assigns it to the Data field.
func (o *GetBetaPrograms200Response) SetData(v []GetBetaPrograms200ResponseAllOfDataInner) {
	o.Data = v
}

func (o GetBetaPrograms200Response) MarshalJSON() ([]byte, error) {
...
func (o GetBetaPrograms200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetBetaPrograms200Response struct {
	value *GetBetaPrograms200Response
	isSet bool
}

func (v NullableGetBetaPrograms200Response) Get() *GetBetaPrograms200Response {
	return v.value
}

func (v *NullableGetBetaPrograms200Response) Set(val *GetBetaPrograms200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBetaPrograms200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBetaPrograms200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBetaPrograms200Response(val *GetBetaPrograms200Response) *NullableGetBetaPrograms200Response {
	return &NullableGetBetaPrograms200Response{value: val, isSet: true}
}

func (v NullableGetBetaPrograms200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBetaPrograms200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
