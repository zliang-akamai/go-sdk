...
// checks if the GetLongviewSubscriptions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLongviewSubscriptions200Response{}

// GetLongviewSubscriptions200Response struct for GetLongviewSubscriptions200Response
type GetLongviewSubscriptions200Response struct {
	Data []GetLongviewPlan200Response `json:"data,omitempty"`
...
func NewGetLongviewSubscriptions200Response() *GetLongviewSubscriptions200Response {
	this := GetLongviewSubscriptions200Response{}
	return &this
}
...
func (o *GetLongviewSubscriptions200Response) GetData() []GetLongviewPlan200Response {
	if o == nil || IsNil(o.Data) {
		var ret []GetLongviewPlan200Response
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLongviewPlan200Response and assigns it to the Data field.
...
func (o GetLongviewSubscriptions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLongviewSubscriptions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLongviewSubscriptions200Response struct {
	value *GetLongviewSubscriptions200Response
	isSet bool
}

func (v NullableGetLongviewSubscriptions200Response) Get() *GetLongviewSubscriptions200Response {
	return v.value
}

func (v *NullableGetLongviewSubscriptions200Response) Set(val *GetLongviewSubscriptions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLongviewSubscriptions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLongviewSubscriptions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLongviewSubscriptions200Response(val *GetLongviewSubscriptions200Response) *NullableGetLongviewSubscriptions200Response {
	return &NullableGetLongviewSubscriptions200Response{value: val, isSet: true}
}

func (v NullableGetLongviewSubscriptions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLongviewSubscriptions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
