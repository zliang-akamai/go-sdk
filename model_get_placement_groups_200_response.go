...
// checks if the GetPlacementGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPlacementGroups200Response{}

// GetPlacementGroups200Response struct for GetPlacementGroups200Response
type GetPlacementGroups200Response struct {
	Data []GetPlacementGroups200ResponseDataInner `json:"data,omitempty"`
...
func NewGetPlacementGroups200Response() *GetPlacementGroups200Response {
	this := GetPlacementGroups200Response{}
	return &this
}
...
func (o *GetPlacementGroups200Response) GetData() []GetPlacementGroups200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetPlacementGroups200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetPlacementGroups200ResponseDataInner and assigns it to the Data field.
...
func (o GetPlacementGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPlacementGroups200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetPlacementGroups200Response struct {
	value *GetPlacementGroups200Response
	isSet bool
}

func (v NullableGetPlacementGroups200Response) Get() *GetPlacementGroups200Response {
	return v.value
}

func (v *NullableGetPlacementGroups200Response) Set(val *GetPlacementGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPlacementGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPlacementGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPlacementGroups200Response(val *GetPlacementGroups200Response) *NullableGetPlacementGroups200Response {
	return &NullableGetPlacementGroups200Response{value: val, isSet: true}
}

func (v NullableGetPlacementGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPlacementGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
