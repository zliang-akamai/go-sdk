...
// checks if the GetChildAccounts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetChildAccounts200Response{}

// GetChildAccounts200Response struct for GetChildAccounts200Response
type GetChildAccounts200Response struct {
	Data []GetChildAccounts200ResponseDataInner `json:"data,omitempty"`
...
func NewGetChildAccounts200Response() *GetChildAccounts200Response {
	this := GetChildAccounts200Response{}
	return &this
}
...
func (o *GetChildAccounts200Response) GetData() []GetChildAccounts200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetChildAccounts200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetChildAccounts200ResponseDataInner and assigns it to the Data field.
...
func (o GetChildAccounts200Response) MarshalJSON() ([]byte, error) {
...
func (o GetChildAccounts200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetChildAccounts200Response struct {
	value *GetChildAccounts200Response
	isSet bool
}

func (v NullableGetChildAccounts200Response) Get() *GetChildAccounts200Response {
	return v.value
}

func (v *NullableGetChildAccounts200Response) Set(val *GetChildAccounts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetChildAccounts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetChildAccounts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetChildAccounts200Response(val *GetChildAccounts200Response) *NullableGetChildAccounts200Response {
	return &NullableGetChildAccounts200Response{value: val, isSet: true}
}

func (v NullableGetChildAccounts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetChildAccounts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
