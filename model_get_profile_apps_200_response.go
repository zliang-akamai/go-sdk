...
// checks if the GetProfileApps200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetProfileApps200Response{}

// GetProfileApps200Response struct for GetProfileApps200Response
type GetProfileApps200Response struct {
	Data []GetProfileApps200ResponseDataInner `json:"data,omitempty"`
...
func NewGetProfileApps200Response() *GetProfileApps200Response {
	this := GetProfileApps200Response{}
	return &this
}
...
func (o *GetProfileApps200Response) GetData() []GetProfileApps200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetProfileApps200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetProfileApps200ResponseDataInner and assigns it to the Data field.
...
func (o GetProfileApps200Response) MarshalJSON() ([]byte, error) {
...
func (o GetProfileApps200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetProfileApps200Response struct {
	value *GetProfileApps200Response
	isSet bool
}

func (v NullableGetProfileApps200Response) Get() *GetProfileApps200Response {
	return v.value
}

func (v *NullableGetProfileApps200Response) Set(val *GetProfileApps200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetProfileApps200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetProfileApps200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetProfileApps200Response(val *GetProfileApps200Response) *NullableGetProfileApps200Response {
	return &NullableGetProfileApps200Response{value: val, isSet: true}
}

func (v NullableGetProfileApps200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetProfileApps200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
