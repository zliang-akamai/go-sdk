...
// checks if the Volume1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Volume1{}
...
func (o *Volume1) SetLinodeLabelNil() {
...
func (o Volume1) MarshalJSON() ([]byte, error) {
...
func (o Volume1) ToMap() (map[string]interface{}, error) {
...
type NullableVolume1 struct {
	value *Volume1
	isSet bool
}

func (v NullableVolume1) Get() *Volume1 {
	return v.value
}

func (v *NullableVolume1) Set(val *Volume1) {
	v.value = val
	v.isSet = true
}

func (v NullableVolume1) IsSet() bool {
	return v.isSet
}

func (v *NullableVolume1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolume1(val *Volume1) *NullableVolume1 {
	return &NullableVolume1{value: val, isSet: true}
}

func (v NullableVolume1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolume1) UnmarshalJSON(src []byte) error {
	v.isSet = true
