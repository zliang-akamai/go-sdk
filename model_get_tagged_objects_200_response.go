...
// checks if the GetTaggedObjects200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTaggedObjects200Response{}

// GetTaggedObjects200Response struct for GetTaggedObjects200Response
type GetTaggedObjects200Response struct {
	Data []GetTaggedObjects200ResponseDataInner `json:"data,omitempty"`
...
func NewGetTaggedObjects200Response() *GetTaggedObjects200Response {
	this := GetTaggedObjects200Response{}
	return &this
}
...
func (o *GetTaggedObjects200Response) GetData() []GetTaggedObjects200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTaggedObjects200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTaggedObjects200ResponseDataInner and assigns it to the Data field.
...
func (o GetTaggedObjects200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTaggedObjects200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTaggedObjects200Response struct {
	value *GetTaggedObjects200Response
	isSet bool
}

func (v NullableGetTaggedObjects200Response) Get() *GetTaggedObjects200Response {
	return v.value
}

func (v *NullableGetTaggedObjects200Response) Set(val *GetTaggedObjects200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTaggedObjects200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTaggedObjects200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTaggedObjects200Response(val *GetTaggedObjects200Response) *NullableGetTaggedObjects200Response {
	return &NullableGetTaggedObjects200Response{value: val, isSet: true}
}

func (v NullableGetTaggedObjects200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTaggedObjects200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
