...
// checks if the GetLkeTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLkeTypes200Response{}

// GetLkeTypes200Response struct for GetLkeTypes200Response
type GetLkeTypes200Response struct {
	// The Kubernetes types.
	Data []GetLkeTypes200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetLkeTypes200Response) GetData() []GetLkeTypes200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLkeTypes200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLkeTypes200ResponseDataInner and assigns it to the Data field.
...
func (o GetLkeTypes200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLkeTypes200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLkeTypes200Response struct {
	value *GetLkeTypes200Response
	isSet bool
}

func (v NullableGetLkeTypes200Response) Get() *GetLkeTypes200Response {
	return v.value
}

func (v *NullableGetLkeTypes200Response) Set(val *GetLkeTypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLkeTypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLkeTypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLkeTypes200Response(val *GetLkeTypes200Response) *NullableGetLkeTypes200Response {
	return &NullableGetLkeTypes200Response{value: val, isSet: true}
}

func (v NullableGetLkeTypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLkeTypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
