...
// checks if the GetTickets200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTickets200Response{}

// GetTickets200Response struct for GetTickets200Response
type GetTickets200Response struct {
	Data []GetTickets200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetTickets200Response) GetData() []GetTickets200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTickets200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTickets200ResponseDataInner and assigns it to the Data field.
...
func (o GetTickets200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTickets200Response) ToMap() (map[string]interface{}, error) {
