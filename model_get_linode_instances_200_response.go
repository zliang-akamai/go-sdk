...
// checks if the GetLinodeInstances200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinodeInstances200Response{}

// GetLinodeInstances200Response struct for GetLinodeInstances200Response
type GetLinodeInstances200Response struct {
...
func NewGetLinodeInstances200Response() *GetLinodeInstances200Response {
	this := GetLinodeInstances200Response{}
	return &this
}
...
func (o GetLinodeInstances200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLinodeInstances200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinodeInstances200Response struct {
	value *GetLinodeInstances200Response
	isSet bool
}

func (v NullableGetLinodeInstances200Response) Get() *GetLinodeInstances200Response {
	return v.value
}

func (v *NullableGetLinodeInstances200Response) Set(val *GetLinodeInstances200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinodeInstances200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinodeInstances200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinodeInstances200Response(val *GetLinodeInstances200Response) *NullableGetLinodeInstances200Response {
	return &NullableGetLinodeInstances200Response{value: val, isSet: true}
}

func (v NullableGetLinodeInstances200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinodeInstances200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
