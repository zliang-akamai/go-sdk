...
// checks if the GetManagedLinodeSettings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetManagedLinodeSettings200Response{}

// GetManagedLinodeSettings200Response struct for GetManagedLinodeSettings200Response
type GetManagedLinodeSettings200Response struct {
	Data []GetManagedLinodeSettings200ResponseDataInner `json:"data,omitempty"`
...
func NewGetManagedLinodeSettings200Response() *GetManagedLinodeSettings200Response {
	this := GetManagedLinodeSettings200Response{}
	return &this
}
...
func (o *GetManagedLinodeSettings200Response) GetData() []GetManagedLinodeSettings200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetManagedLinodeSettings200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetManagedLinodeSettings200ResponseDataInner and assigns it to the Data field.
...
func (o GetManagedLinodeSettings200Response) MarshalJSON() ([]byte, error) {
...
func (o GetManagedLinodeSettings200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetManagedLinodeSettings200Response struct {
	value *GetManagedLinodeSettings200Response
	isSet bool
}

func (v NullableGetManagedLinodeSettings200Response) Get() *GetManagedLinodeSettings200Response {
	return v.value
}

func (v *NullableGetManagedLinodeSettings200Response) Set(val *GetManagedLinodeSettings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetManagedLinodeSettings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetManagedLinodeSettings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetManagedLinodeSettings200Response(val *GetManagedLinodeSettings200Response) *NullableGetManagedLinodeSettings200Response {
	return &NullableGetManagedLinodeSettings200Response{value: val, isSet: true}
}

func (v NullableGetManagedLinodeSettings200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetManagedLinodeSettings200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
