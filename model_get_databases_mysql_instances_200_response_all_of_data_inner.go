...
// checks if the GetDatabasesMysqlInstances200ResponseAllOfDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDatabasesMysqlInstances200ResponseAllOfDataInner{}

// GetDatabasesMysqlInstances200ResponseAllOfDataInner Managed MySQL Databases object.
type GetDatabasesMysqlInstances200ResponseAllOfDataInner struct {
...
func NewGetDatabasesMysqlInstances200ResponseAllOfDataInner() *GetDatabasesMysqlInstances200ResponseAllOfDataInner {
	this := GetDatabasesMysqlInstances200ResponseAllOfDataInner{}
...
func (o GetDatabasesMysqlInstances200ResponseAllOfDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetDatabasesMysqlInstances200ResponseAllOfDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner struct {
	value *GetDatabasesMysqlInstances200ResponseAllOfDataInner
	isSet bool
}

func (v NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) Get() *GetDatabasesMysqlInstances200ResponseAllOfDataInner {
	return v.value
}

func (v *NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) Set(val *GetDatabasesMysqlInstances200ResponseAllOfDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDatabasesMysqlInstances200ResponseAllOfDataInner(val *GetDatabasesMysqlInstances200ResponseAllOfDataInner) *NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner {
	return &NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner{value: val, isSet: true}
}

func (v NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDatabasesMysqlInstances200ResponseAllOfDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
