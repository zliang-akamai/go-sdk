...
// checks if the GetPersonalAccessTokens200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPersonalAccessTokens200Response{}

// GetPersonalAccessTokens200Response struct for GetPersonalAccessTokens200Response
type GetPersonalAccessTokens200Response struct {
	Data []GetPersonalAccessTokens200ResponseDataInner `json:"data,omitempty"`
...
func NewGetPersonalAccessTokens200Response() *GetPersonalAccessTokens200Response {
	this := GetPersonalAccessTokens200Response{}
	return &this
}
...
func (o *GetPersonalAccessTokens200Response) GetData() []GetPersonalAccessTokens200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetPersonalAccessTokens200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetPersonalAccessTokens200ResponseDataInner and assigns it to the Data field.
...
func (o GetPersonalAccessTokens200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPersonalAccessTokens200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetPersonalAccessTokens200Response struct {
	value *GetPersonalAccessTokens200Response
	isSet bool
}

func (v NullableGetPersonalAccessTokens200Response) Get() *GetPersonalAccessTokens200Response {
	return v.value
}

func (v *NullableGetPersonalAccessTokens200Response) Set(val *GetPersonalAccessTokens200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPersonalAccessTokens200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPersonalAccessTokens200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPersonalAccessTokens200Response(val *GetPersonalAccessTokens200Response) *NullableGetPersonalAccessTokens200Response {
	return &NullableGetPersonalAccessTokens200Response{value: val, isSet: true}
}

func (v NullableGetPersonalAccessTokens200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPersonalAccessTokens200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
