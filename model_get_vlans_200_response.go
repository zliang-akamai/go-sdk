...
// checks if the GetVlans200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVlans200Response{}

// GetVlans200Response struct for GetVlans200Response
type GetVlans200Response struct {
	Data []GetVlans200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetVlans200Response) GetData() []GetVlans200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetVlans200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetVlans200ResponseDataInner and assigns it to the Data field.
...
func (o GetVlans200Response) MarshalJSON() ([]byte, error) {
...
func (o GetVlans200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetVlans200Response struct {
	value *GetVlans200Response
	isSet bool
}

func (v NullableGetVlans200Response) Get() *GetVlans200Response {
	return v.value
}

func (v *NullableGetVlans200Response) Set(val *GetVlans200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVlans200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVlans200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVlans200Response(val *GetVlans200Response) *NullableGetVlans200Response {
	return &NullableGetVlans200Response{value: val, isSet: true}
}

func (v NullableGetVlans200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVlans200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
