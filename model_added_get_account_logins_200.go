...
// checks if the AddedGetAccountLogins200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedGetAccountLogins200{}

// AddedGetAccountLogins200 struct for AddedGetAccountLogins200
type AddedGetAccountLogins200 struct {
...
func (o AddedGetAccountLogins200) MarshalJSON() ([]byte, error) {
...
func (o AddedGetAccountLogins200) ToMap() (map[string]interface{}, error) {
...
type NullableAddedGetAccountLogins200 struct {
	value *AddedGetAccountLogins200
	isSet bool
}

func (v NullableAddedGetAccountLogins200) Get() *AddedGetAccountLogins200 {
	return v.value
}

func (v *NullableAddedGetAccountLogins200) Set(val *AddedGetAccountLogins200) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedGetAccountLogins200) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedGetAccountLogins200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedGetAccountLogins200(val *AddedGetAccountLogins200) *NullableAddedGetAccountLogins200 {
	return &NullableAddedGetAccountLogins200{value: val, isSet: true}
}

func (v NullableAddedGetAccountLogins200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedGetAccountLogins200) UnmarshalJSON(src []byte) error {
	v.isSet = true
