...
// checks if the GetEnrolledBetaPrograms200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEnrolledBetaPrograms200Response{}

// GetEnrolledBetaPrograms200Response struct for GetEnrolledBetaPrograms200Response
type GetEnrolledBetaPrograms200Response struct {
	...
	Data []GetEnrolledBetaPrograms200ResponseAllOfDataInner `json:"data,omitempty"`
}
...
func NewGetEnrolledBetaPrograms200Response() *GetEnrolledBetaPrograms200Response {
	this := GetEnrolledBetaPrograms200Response{}
	return &this
}
...
func (o *GetEnrolledBetaPrograms200Response) GetData() []GetEnrolledBetaPrograms200ResponseAllOfDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetEnrolledBetaPrograms200ResponseAllOfDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetEnrolledBetaPrograms200ResponseAllOfDataInner and assigns it to the Data field.
func (o *GetEnrolledBetaPrograms200Response) SetData(v []GetEnrolledBetaPrograms200ResponseAllOfDataInner) {
	o.Data = v
}

func (o GetEnrolledBetaPrograms200Response) MarshalJSON() ([]byte, error) {
...
func (o GetEnrolledBetaPrograms200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetEnrolledBetaPrograms200Response struct {
	value *GetEnrolledBetaPrograms200Response
	isSet bool
}

func (v NullableGetEnrolledBetaPrograms200Response) Get() *GetEnrolledBetaPrograms200Response {
	return v.value
}

func (v *NullableGetEnrolledBetaPrograms200Response) Set(val *GetEnrolledBetaPrograms200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEnrolledBetaPrograms200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEnrolledBetaPrograms200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEnrolledBetaPrograms200Response(val *GetEnrolledBetaPrograms200Response) *NullableGetEnrolledBetaPrograms200Response {
	return &NullableGetEnrolledBetaPrograms200Response{value: val, isSet: true}
}

func (v NullableGetEnrolledBetaPrograms200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEnrolledBetaPrograms200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
