...
// checks if the GetLinodeTypes200ResponseDataInnerRegionPricesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinodeTypes200ResponseDataInnerRegionPricesInner{}

// GetLinodeTypes200ResponseDataInnerRegionPricesInner struct for GetLinodeTypes200ResponseDataInnerRegionPricesInner
type GetLinodeTypes200ResponseDataInnerRegionPricesInner struct {
...
func NewGetLinodeTypes200ResponseDataInnerRegionPricesInner() *GetLinodeTypes200ResponseDataInnerRegionPricesInner {
	this := GetLinodeTypes200ResponseDataInnerRegionPricesInner{}
	return &this
}
...
func (o GetLinodeTypes200ResponseDataInnerRegionPricesInner) MarshalJSON() ([]byte, error) {
...
func (o GetLinodeTypes200ResponseDataInnerRegionPricesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner struct {
	value *GetLinodeTypes200ResponseDataInnerRegionPricesInner
	isSet bool
}

func (v NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) Get() *GetLinodeTypes200ResponseDataInnerRegionPricesInner {
	return v.value
}

func (v *NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) Set(val *GetLinodeTypes200ResponseDataInnerRegionPricesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinodeTypes200ResponseDataInnerRegionPricesInner(val *GetLinodeTypes200ResponseDataInnerRegionPricesInner) *NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner {
	return &NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner{value: val, isSet: true}
}

func (v NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinodeTypes200ResponseDataInnerRegionPricesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
