...
// checks if the GetDatabasesInstances200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDatabasesInstances200Response{}

// GetDatabasesInstances200Response struct for GetDatabasesInstances200Response
type GetDatabasesInstances200Response struct {
	...
	Data []GetDatabasesInstances200ResponseAllOfDataInner `json:"data,omitempty"`
}
...
func NewGetDatabasesInstances200Response() *GetDatabasesInstances200Response {
	this := GetDatabasesInstances200Response{}
	return &this
}
...
func (o *GetDatabasesInstances200Response) GetData() []GetDatabasesInstances200ResponseAllOfDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDatabasesInstances200ResponseAllOfDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDatabasesInstances200ResponseAllOfDataInner and assigns it to the Data field.
func (o *GetDatabasesInstances200Response) SetData(v []GetDatabasesInstances200ResponseAllOfDataInner) {
	o.Data = v
}

func (o GetDatabasesInstances200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDatabasesInstances200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDatabasesInstances200Response struct {
	value *GetDatabasesInstances200Response
	isSet bool
}

func (v NullableGetDatabasesInstances200Response) Get() *GetDatabasesInstances200Response {
	return v.value
}

func (v *NullableGetDatabasesInstances200Response) Set(val *GetDatabasesInstances200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDatabasesInstances200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDatabasesInstances200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDatabasesInstances200Response(val *GetDatabasesInstances200Response) *NullableGetDatabasesInstances200Response {
	return &NullableGetDatabasesInstances200Response{value: val, isSet: true}
}

func (v NullableGetDatabasesInstances200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDatabasesInstances200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
