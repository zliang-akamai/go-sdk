...
// checks if the GetNodeBalancerTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeBalancerTypes200Response{}

// GetNodeBalancerTypes200Response struct for GetNodeBalancerTypes200Response
type GetNodeBalancerTypes200Response struct {
	// The NodeBalancer types.
	Data []GetNodeBalancerTypes200ResponseDataInner `json:"data,omitempty"`
...
func NewGetNodeBalancerTypes200Response() *GetNodeBalancerTypes200Response {
	this := GetNodeBalancerTypes200Response{}
	return &this
}
...
func (o *GetNodeBalancerTypes200Response) GetData() []GetNodeBalancerTypes200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetNodeBalancerTypes200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetNodeBalancerTypes200ResponseDataInner and assigns it to the Data field.
...
func (o GetNodeBalancerTypes200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodeBalancerTypes200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNodeBalancerTypes200Response struct {
	value *GetNodeBalancerTypes200Response
	isSet bool
}

func (v NullableGetNodeBalancerTypes200Response) Get() *GetNodeBalancerTypes200Response {
	return v.value
}

func (v *NullableGetNodeBalancerTypes200Response) Set(val *GetNodeBalancerTypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeBalancerTypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeBalancerTypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeBalancerTypes200Response(val *GetNodeBalancerTypes200Response) *NullableGetNodeBalancerTypes200Response {
	return &NullableGetNodeBalancerTypes200Response{value: val, isSet: true}
}

func (v NullableGetNodeBalancerTypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeBalancerTypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
