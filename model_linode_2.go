...
// checks if the Linode2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Linode2{}

// Linode2 struct for Linode2
type Linode2 struct {
...
func (o *Linode2) SetDiskEncryptionNil() {
...
func (o *Linode2) SetLkeClusterIdNil() {
...
func (o *Linode2) SetPlacementGroupNil() {
...
func (o Linode2) MarshalJSON() ([]byte, error) {
...
func (o Linode2) ToMap() (map[string]interface{}, error) {
...
type NullableLinode2 struct {
	value *Linode2
	isSet bool
}

func (v NullableLinode2) Get() *Linode2 {
	return v.value
}

func (v *NullableLinode2) Set(val *Linode2) {
	v.value = val
	v.isSet = true
}

func (v NullableLinode2) IsSet() bool {
	return v.isSet
}

func (v *NullableLinode2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinode2(val *Linode2) *NullableLinode2 {
	return &NullableLinode2{value: val, isSet: true}
}

func (v NullableLinode2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinode2) UnmarshalJSON(src []byte) error {
	v.isSet = true
