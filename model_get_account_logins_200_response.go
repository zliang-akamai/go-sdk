...
// checks if the GetAccountLogins200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountLogins200Response{}

// GetAccountLogins200Response struct for GetAccountLogins200Response
type GetAccountLogins200Response struct {
	Data []GetAccountLogins200ResponseDataInner `json:"data,omitempty"`
...
func NewGetAccountLogins200Response() *GetAccountLogins200Response {
	this := GetAccountLogins200Response{}
	return &this
}
...
func (o *GetAccountLogins200Response) GetData() []GetAccountLogins200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetAccountLogins200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetAccountLogins200ResponseDataInner and assigns it to the Data field.
...
func (o GetAccountLogins200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAccountLogins200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountLogins200Response struct {
	value *GetAccountLogins200Response
	isSet bool
}

func (v NullableGetAccountLogins200Response) Get() *GetAccountLogins200Response {
	return v.value
}

func (v *NullableGetAccountLogins200Response) Set(val *GetAccountLogins200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountLogins200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountLogins200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountLogins200Response(val *GetAccountLogins200Response) *NullableGetAccountLogins200Response {
	return &NullableGetAccountLogins200Response{value: val, isSet: true}
}

func (v NullableGetAccountLogins200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountLogins200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
