...
// checks if the PutDatabasesMysqlInstanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutDatabasesMysqlInstanceRequest{}

// PutDatabasesMysqlInstanceRequest Updated information for the Managed MySQL Database.
type PutDatabasesMysqlInstanceRequest struct {
...
func NewPutDatabasesMysqlInstanceRequest() *PutDatabasesMysqlInstanceRequest {
	this := PutDatabasesMysqlInstanceRequest{}
	return &this
}
...
func (o PutDatabasesMysqlInstanceRequest) MarshalJSON() ([]byte, error) {
...
func (o PutDatabasesMysqlInstanceRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutDatabasesMysqlInstanceRequest struct {
	value *PutDatabasesMysqlInstanceRequest
	isSet bool
}

func (v NullablePutDatabasesMysqlInstanceRequest) Get() *PutDatabasesMysqlInstanceRequest {
	return v.value
}

func (v *NullablePutDatabasesMysqlInstanceRequest) Set(val *PutDatabasesMysqlInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutDatabasesMysqlInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutDatabasesMysqlInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutDatabasesMysqlInstanceRequest(val *PutDatabasesMysqlInstanceRequest) *NullablePutDatabasesMysqlInstanceRequest {
	return &NullablePutDatabasesMysqlInstanceRequest{value: val, isSet: true}
}

func (v NullablePutDatabasesMysqlInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutDatabasesMysqlInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
