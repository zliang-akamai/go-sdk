...
// checks if the GetRegions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRegions200Response{}

// GetRegions200Response struct for GetRegions200Response
type GetRegions200Response struct {
	Data []GetRegions200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetRegions200Response) GetData() []GetRegions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetRegions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetRegions200ResponseDataInner and assigns it to the Data field.
...
func (o GetRegions200Response) ToMap() (map[string]interface{}, error) {
