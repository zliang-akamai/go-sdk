...
// checks if the GetObjectStorageKeys200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetObjectStorageKeys200Response{}

// GetObjectStorageKeys200Response struct for GetObjectStorageKeys200Response
type GetObjectStorageKeys200Response struct {
	Data []GetObjectStorageKeys200ResponseDataInner `json:"data,omitempty"`
...
func NewGetObjectStorageKeys200Response() *GetObjectStorageKeys200Response {
	this := GetObjectStorageKeys200Response{}
	return &this
}
...
func (o *GetObjectStorageKeys200Response) GetData() []GetObjectStorageKeys200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetObjectStorageKeys200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetObjectStorageKeys200ResponseDataInner and assigns it to the Data field.
...
func (o GetObjectStorageKeys200Response) MarshalJSON() ([]byte, error) {
...
func (o GetObjectStorageKeys200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetObjectStorageKeys200Response struct {
	value *GetObjectStorageKeys200Response
	isSet bool
}

func (v NullableGetObjectStorageKeys200Response) Get() *GetObjectStorageKeys200Response {
	return v.value
}

func (v *NullableGetObjectStorageKeys200Response) Set(val *GetObjectStorageKeys200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetObjectStorageKeys200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetObjectStorageKeys200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetObjectStorageKeys200Response(val *GetObjectStorageKeys200Response) *NullableGetObjectStorageKeys200Response {
	return &NullableGetObjectStorageKeys200Response{value: val, isSet: true}
}

func (v NullableGetObjectStorageKeys200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetObjectStorageKeys200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
