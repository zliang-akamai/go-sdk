...
// checks if the GetLinodeFirewalls200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinodeFirewalls200Response{}

// GetLinodeFirewalls200Response struct for GetLinodeFirewalls200Response
type GetLinodeFirewalls200Response struct {
...
func NewGetLinodeFirewalls200Response() *GetLinodeFirewalls200Response {
	this := GetLinodeFirewalls200Response{}
	return &this
}
...
func (o GetLinodeFirewalls200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLinodeFirewalls200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinodeFirewalls200Response struct {
	value *GetLinodeFirewalls200Response
	isSet bool
}

func (v NullableGetLinodeFirewalls200Response) Get() *GetLinodeFirewalls200Response {
	return v.value
}

func (v *NullableGetLinodeFirewalls200Response) Set(val *GetLinodeFirewalls200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinodeFirewalls200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinodeFirewalls200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinodeFirewalls200Response(val *GetLinodeFirewalls200Response) *NullableGetLinodeFirewalls200Response {
	return &NullableGetLinodeFirewalls200Response{value: val, isSet: true}
}

func (v NullableGetLinodeFirewalls200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinodeFirewalls200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
