...
// checks if the GetDatabasesEngines200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDatabasesEngines200Response{}

// GetDatabasesEngines200Response struct for GetDatabasesEngines200Response
type GetDatabasesEngines200Response struct {
	...
	Data []GetDatabasesEngines200ResponseAllOfDataInner `json:"data,omitempty"`
}
...
func NewGetDatabasesEngines200Response() *GetDatabasesEngines200Response {
	this := GetDatabasesEngines200Response{}
	return &this
}
...
func (o *GetDatabasesEngines200Response) GetData() []GetDatabasesEngines200ResponseAllOfDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDatabasesEngines200ResponseAllOfDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDatabasesEngines200ResponseAllOfDataInner and assigns it to the Data field.
func (o *GetDatabasesEngines200Response) SetData(v []GetDatabasesEngines200ResponseAllOfDataInner) {
	o.Data = v
}

func (o GetDatabasesEngines200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDatabasesEngines200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDatabasesEngines200Response struct {
	value *GetDatabasesEngines200Response
	isSet bool
}

func (v NullableGetDatabasesEngines200Response) Get() *GetDatabasesEngines200Response {
	return v.value
}

func (v *NullableGetDatabasesEngines200Response) Set(val *GetDatabasesEngines200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDatabasesEngines200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDatabasesEngines200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDatabasesEngines200Response(val *GetDatabasesEngines200Response) *NullableGetDatabasesEngines200Response {
	return &NullableGetDatabasesEngines200Response{value: val, isSet: true}
}

func (v NullableGetDatabasesEngines200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDatabasesEngines200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
