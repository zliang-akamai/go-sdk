...
// checks if the GetManagedIssues200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetManagedIssues200Response{}

// GetManagedIssues200Response struct for GetManagedIssues200Response
type GetManagedIssues200Response struct {
	Data []GetManagedIssues200ResponseDataInner `json:"data,omitempty"`
...
func NewGetManagedIssues200Response() *GetManagedIssues200Response {
	this := GetManagedIssues200Response{}
	return &this
}
...
func (o *GetManagedIssues200Response) GetData() []GetManagedIssues200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetManagedIssues200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetManagedIssues200ResponseDataInner and assigns it to the Data field.
...
func (o GetManagedIssues200Response) MarshalJSON() ([]byte, error) {
...
func (o GetManagedIssues200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetManagedIssues200Response struct {
	value *GetManagedIssues200Response
	isSet bool
}

func (v NullableGetManagedIssues200Response) Get() *GetManagedIssues200Response {
	return v.value
}

func (v *NullableGetManagedIssues200Response) Set(val *GetManagedIssues200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetManagedIssues200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetManagedIssues200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetManagedIssues200Response(val *GetManagedIssues200Response) *NullableGetManagedIssues200Response {
	return &NullableGetManagedIssues200Response{value: val, isSet: true}
}

func (v NullableGetManagedIssues200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetManagedIssues200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
