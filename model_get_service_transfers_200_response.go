...
// checks if the GetServiceTransfers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServiceTransfers200Response{}

// GetServiceTransfers200Response struct for GetServiceTransfers200Response
type GetServiceTransfers200Response struct {
...
func NewGetServiceTransfers200Response() *GetServiceTransfers200Response {
	this := GetServiceTransfers200Response{}
	return &this
}
...
func (o GetServiceTransfers200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServiceTransfers200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServiceTransfers200Response struct {
	value *GetServiceTransfers200Response
	isSet bool
}

func (v NullableGetServiceTransfers200Response) Get() *GetServiceTransfers200Response {
	return v.value
}

func (v *NullableGetServiceTransfers200Response) Set(val *GetServiceTransfers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServiceTransfers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServiceTransfers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServiceTransfers200Response(val *GetServiceTransfers200Response) *NullableGetServiceTransfers200Response {
	return &NullableGetServiceTransfers200Response{value: val, isSet: true}
}

func (v NullableGetServiceTransfers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServiceTransfers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
