...
// checks if the GetTicketReplies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTicketReplies200Response{}

// GetTicketReplies200Response struct for GetTicketReplies200Response
type GetTicketReplies200Response struct {
	Data []GetTicketReplies200ResponseDataInner `json:"data,omitempty"`
...
func NewGetTicketReplies200Response() *GetTicketReplies200Response {
	this := GetTicketReplies200Response{}
	return &this
}
...
func (o *GetTicketReplies200Response) GetData() []GetTicketReplies200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTicketReplies200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTicketReplies200ResponseDataInner and assigns it to the Data field.
...
func (o GetTicketReplies200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTicketReplies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTicketReplies200Response struct {
	value *GetTicketReplies200Response
	isSet bool
}

func (v NullableGetTicketReplies200Response) Get() *GetTicketReplies200Response {
	return v.value
}

func (v *NullableGetTicketReplies200Response) Set(val *GetTicketReplies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTicketReplies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTicketReplies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTicketReplies200Response(val *GetTicketReplies200Response) *NullableGetTicketReplies200Response {
	return &NullableGetTicketReplies200Response{value: val, isSet: true}
}

func (v NullableGetTicketReplies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTicketReplies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
