...
// checks if the AddedGetUser200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedGetUser200{}

// AddedGetUser200 struct for AddedGetUser200
type AddedGetUser200 struct {
...
func (o *AddedGetUser200) SetLastLoginNil() {
	o.LastLogin.Set(nil)
}
...
func (o *AddedGetUser200) SetPasswordCreatedNil() {
...
func (o *AddedGetUser200) SetVerifiedPhoneNumberNil() {
...
func (o AddedGetUser200) MarshalJSON() ([]byte, error) {
...
func (o AddedGetUser200) ToMap() (map[string]interface{}, error) {
...
type NullableAddedGetUser200 struct {
	value *AddedGetUser200
	isSet bool
}

func (v NullableAddedGetUser200) Get() *AddedGetUser200 {
	return v.value
}

func (v *NullableAddedGetUser200) Set(val *AddedGetUser200) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedGetUser200) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedGetUser200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedGetUser200(val *AddedGetUser200) *NullableAddedGetUser200 {
	return &NullableAddedGetUser200{value: val, isSet: true}
}

func (v NullableAddedGetUser200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedGetUser200) UnmarshalJSON(src []byte) error {
	v.isSet = true
