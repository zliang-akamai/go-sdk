...
// checks if the Domain1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Domain1{}
...
func (o Domain1) MarshalJSON() ([]byte, error) {
...
func (o Domain1) ToMap() (map[string]interface{}, error) {
...
type NullableDomain1 struct {
	value *Domain1
	isSet bool
}

func (v NullableDomain1) Get() *Domain1 {
	return v.value
}

func (v *NullableDomain1) Set(val *Domain1) {
	v.value = val
	v.isSet = true
}

func (v NullableDomain1) IsSet() bool {
	return v.isSet
}

func (v *NullableDomain1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomain1(val *Domain1) *NullableDomain1 {
	return &NullableDomain1{value: val, isSet: true}
}

func (v NullableDomain1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomain1) UnmarshalJSON(src []byte) error {
	v.isSet = true
