...
// checks if the GetKernels200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetKernels200Response{}

// GetKernels200Response struct for GetKernels200Response
type GetKernels200Response struct {
	Data []GetKernels200ResponseDataInner `json:"data,omitempty"`
...
func (o *GetKernels200Response) GetData() []GetKernels200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetKernels200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetKernels200ResponseDataInner and assigns it to the Data field.
...
func (o GetKernels200Response) MarshalJSON() ([]byte, error) {
...
func (o GetKernels200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetKernels200Response struct {
	value *GetKernels200Response
	isSet bool
}

func (v NullableGetKernels200Response) Get() *GetKernels200Response {
	return v.value
}

func (v *NullableGetKernels200Response) Set(val *GetKernels200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetKernels200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetKernels200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetKernels200Response(val *GetKernels200Response) *NullableGetKernels200Response {
	return &NullableGetKernels200Response{value: val, isSet: true}
}

func (v NullableGetKernels200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetKernels200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
