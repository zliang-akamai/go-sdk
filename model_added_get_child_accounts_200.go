...
// checks if the AddedGetChildAccounts200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedGetChildAccounts200{}

// AddedGetChildAccounts200 struct for AddedGetChildAccounts200
type AddedGetChildAccounts200 struct {
...
func (o AddedGetChildAccounts200) MarshalJSON() ([]byte, error) {
...
func (o AddedGetChildAccounts200) ToMap() (map[string]interface{}, error) {
...
type NullableAddedGetChildAccounts200 struct {
	value *AddedGetChildAccounts200
	isSet bool
}

func (v NullableAddedGetChildAccounts200) Get() *AddedGetChildAccounts200 {
	return v.value
}

func (v *NullableAddedGetChildAccounts200) Set(val *AddedGetChildAccounts200) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedGetChildAccounts200) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedGetChildAccounts200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedGetChildAccounts200(val *AddedGetChildAccounts200) *NullableAddedGetChildAccounts200 {
	return &NullableAddedGetChildAccounts200{value: val, isSet: true}
}

func (v NullableAddedGetChildAccounts200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedGetChildAccounts200) UnmarshalJSON(src []byte) error {
	v.isSet = true
